...
public class ActionEventConstant {
	public static final int ACTION_CHANGE_VIEW_WELLCOME = 1;
	public static final int ACTION_CHANGE_VIEW_LOGIN = 2;
	public static final int ACTION_CHANGE_VIEW_SIGNUP = 3;
	public static final int ACTION_CHANGE_VIEW_MAIN_ACTIVTY = 4;
	public static final int ACTION_DO_LOGIN = 5;
